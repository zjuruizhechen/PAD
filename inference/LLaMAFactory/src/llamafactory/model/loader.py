...
from .modeling_value_head import AutoModelForCausalLMWith2ValueHead, AutoModelForCausalLMWithDPOValueHead
...
def load_model(
    ...
    if add_dpovaluehead:
        model = AutoModelForCausalLMWithDPOValueHead.from_pretrained(model)
        patch_valuehead_model(model)
